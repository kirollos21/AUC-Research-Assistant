...
def test_basic_api():
    ...
    try:
        ...
        print(f"✅ Ping endpoint: {response.status_code} - {response.json()['message']}")
...
def test_search_endpoints_without_llm():
    ...
    try:
        ...
        print(f"✅ Federated search service initialized with {len(search_service.connectors)} connectors")
